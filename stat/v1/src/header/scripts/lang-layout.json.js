var langLayoutObj = {
    'BG-BG': {
        ...
        'Comment': 'Въведете вашия коментар', 
    ...
    'CS-CZ': {
        ...
        'Comment': 'Zadejte prosím svůj komentář.',
    ...
    'DE-AT': {
        ...
        'Comment': 'Bitte geben Sie Ihren Kommentar ein.',
    ...
    'ET-EE': {
        ...
        'Comment': 'Kirjutage kommentaar',
        'Current time zone': 'Praegune ajavöönd',
        'Email Optional': 'Meiliaadress (valikuline)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Tagasiside',
    ...
    'HR-HR': {
        ...
        'Email Optional': 'E-pošta (neobavezno)',
        'Environment': 'Environment',
        'Environments': 'Environments',
    ...
    'HU-HU': {
        ...
        'Comment': 'Kérjük, írja be az észrevételét',
        'Current time zone': 'Jelenlegi időzóna',
        'Email Optional': 'E-mail-cím (nem kötelező)',
        'Environment': 'Environment',
        'Environments': 'Environments',
    ...
    'KK-KZ': {
        ...
        'Comment': 'Комментарийіңізді енгізіңіз',
        'Current time zone': 'Ағымдағы уақыт белдеуі',
        'Email Optional': 'Электрондық пошта (міндетті емес)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Пікір',
    ...
    'LT-LT': {
        ...
        'Comment': 'Įrašykite savo komentarą',
    ...
    'RO-RO': {
        ...
        'Comment': 'Introduceți un comentariu',
        'Current time zone': 'Fus orar actual',
        'Email Optional': 'E-mail (opțional)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Feedback',
    ...
    'SR-LATN-CS': {
        ...
        'Comment': 'Otkucajte komentar',
        'Current time zone': 'Trenutna vremenska zona',
        'Email Optional': 'E-adresa (opcionalno)',       
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Povratne informacije',
    ...
    'RU-RU': {
        ...
        'Comment': 'Введите свой комментарий',
        'Current time zone': 'Текущий часовой пояс',
        'Email Optional': 'Электронный адрес (необязательно)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Отзыв',
    ...
    'SL-SI': {
        ...
        'Comment': 'Vnesite svojo pripombo',
        'Current time zone': 'Trenutni časovni pas',
        'Email Optional': 'E-pošta (izbirno)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Povratne informacije',
    ...
    'TR-TR': {
        ...
        'Comment': 'Lütfen yorumunuzu yazın',
    ...
    'UK-UA': {
        ...
        'Comment': 'Введіть свій коментар',
        'Current time zone': 'Поточний часовий пояс',
        'Email Optional': 'Електронна пошта (необов’язково)',
        'Environment': 'Environment',
        'Environments': 'Environments',
        'Feedback': 'Відгук',
