...
function distanceMatrix() {
	var itemJson = {
		'origins': [{
			'latitude': 12.910377,
			'longitude': 100.858133
		}],
		'destinations': [{
			'latitude': 12.934652,
			'longitude': 100.883655
		}],
		'travelMode': 'driving'
	}
	...
	$.ajax({
		...
		//   request.setRequestHeader('Content-Length', 450)
		//   request.setRequestHeader('Content-Type', 'application/json')
		// },
		url: url,
		data: 'json=' + JSON.stringify(itemJson),
		processData: false,
